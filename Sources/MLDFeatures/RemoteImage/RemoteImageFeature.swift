...
public extension RemoteImageFeature {
    struct State: Equatable, Identifiable {
        ...
        // public / URL as a string for the image. Defaults to empty string
        public var imageStringURL: String

        /// Placeholder image. If redactions are disabled it is shown while loading. Otherwise it's shown only in case of image loading error
        ...
        public var redactedReasons: RedactionReasons = []
